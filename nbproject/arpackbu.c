...
if (DEBUG_LVL > 100)    printf("\nedong in arpackbu.c: preparing invoking spooles\n");
...
if (DEBUG_LVL > 100)    printf("\nedong in arpackbu.c: preparing invoking spooles_factor\n");
...
if (DEBUG_LVL > 100)    printf("\nedong in arpackbu.c: preparing invoking spooles_solve\n");
...
if (DEBUG_LVL > 100)    printf("\nedong in arpackbu.c: preparing invoking spooles_cleanup\n");
    spooles_cleanup();
#endif
  }
  else if(*isolver==4){
