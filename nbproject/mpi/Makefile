...
CFLAGS = -Wall -O3 -fopenmp -I ../../../SPOOLES.2.2/ -I ../../../SPOOLES.2.2/MPI -DARCH="Linux" -DSPOOLES -DARPACK -DMATRIXSTORAGE -DUSE_MT=1 -DCALCULIX_MPI=1 -DDEBUG_LVL=101 -DMPI_READY
